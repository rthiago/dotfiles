...
yay -S --needed --noconfirm adobe-source-sans-pro-fonts ananicy-git apache automake cifs-utils cronie docker dropbox exfat-utils file-roller firefox flac fuse-common fuse-exfat fzf git google-chrome gparted gpmdp hdparm htop httpie icedtea-web imagemagick intel-ucode iotop net-tools openssh pkgfile powertop pygmentize screen ttf-hack ttf-liberation ttf-ms-fonts ttf-ubuntu-font-family ttf-vista-fonts gvim xclip wget zsh-syntax-highlighting telegram-desktop-bin terminator dropbox-cli php python tor nmap proxychains-ng aircrack-ng crunch rfkill bc ltrace strace alsa-utils sslstrip dsniff ntp redis ctop transmission-gtk mpv sublime-text usbguard gimp jq tmux diff-so-fancy meld i3-gaps rofi polybar feh i3lock-fancy-rapid scrot picom ttf-windows ttf-selawik noto-fonts-emoji ttf-oxygen-gf siji-git nodejs npm yarn nvm ripgrep docker-compose ibus autossh playerctl ccat fd bat
